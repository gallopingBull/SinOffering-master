...
namespace UnitySpriteCutter {
    ...
    public class SpriteSetter
    {
        public void SetSprites()
        {
            ...
            //gameObject.GetComponent<SpriteRenderer>().sprite = sliceSprite;
        }
    }
	...
	public static class SpriteCutter {
        ...
        public static SpriteCutterOutput Cut( SpriteCutterInput input ) {
			...
			if ( input.gameObject == null ) {
				Debug.LogError( "SpriteCutter.Cut exceuted with null gameObject!" );
            ...
            //get exact sprite in sprite sheet and assign it to spriteRenderer
            ...
            //made change into this condition for CUT_OFF_ONE enum.
                ...
                input.gameObject.transform.parent = null; // i add this to remove sprite from parent entity gameobject
                                                          //might have to refactor this after adding object pool for this
